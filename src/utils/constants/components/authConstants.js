...
export const AUTHORIZATION_SPOTIFY_REDIRECT_URI = 'https://wvpaz.github.io/spotifood.github.io/callback'; //'http://localhost:3000/callback';

export const AUTHORIZATION_LOADING_TEXT = 'Getting Access ...';